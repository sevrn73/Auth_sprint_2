...
@router.get('/{person_id}', dependencies=[Depends(JWTBearer())], response_model=ESPerson)
...
@router.get('/persons/', dependencies=[Depends(JWTBearer())], response_model=List[ESPerson])
...
@router.get('/{person_id}/films', dependencies=[Depends(JWTBearer())], response_model=List[Film])
